...
export default function Home() {
  ...
  return (
   ...
   <header className="hero-bg text-white pb-32 relative overflow-hidden">
        <nav className="container mx-auto flex justify-between items-center py-6 px-4">
          <div className="flex items-center gap-3">
            <Image
              ...
              priority
            />
            <span className="text-2xl font-bold tracking-tight">Docovery</span>
          </div>
          <ul className="hidden md:flex gap-8 font-medium">
            ...
            <li>
              <a href="#community" className="hover:text-blue-200 transition">
                Community
              </a>
            </li>
            <li>
              <a href="#team" className="hover:text-blue-200 transition">
                Team
              </a>
            </li>
            <li>
              <a
                href="#contact"
                className="ml-4 px-5 py-2 bg-white text-blue-700 rounded-lg font-bold shadow hover:bg-blue-100 transition"
              >
                Contact
              </a>
            </li>
        ...
        <div
          className={`md:hidden bg-white/90 text-blue-900 px-4 py-4 absolute w-full left-0 top-20 z-50 transition-all duration-300 ${
            menuOpen ? "" : "hidden"
          }`}
          id="mobile-menu"
        >
          ...
          <a href="#team" className="block py-2">
            Team
          </a>
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center pt-10 md:pt-20">
          <div className="md:w-1/2 fade-in-up">
            ...
            <p className="text-lg md:text-xl mb-8 text-blue-100/90 fade-in-up delay-100">
              DoTech is a space for innovation, research, and learning dedicated
              to technology. We explore, analyze, and share advances and
              solutions to address tomorrow&apos;s challenges.
            </p>
            <div className="flex gap-4 fade-in-up delay-200">
              <a
                href="#services"
                className="px-6 py-3 bg-white text-blue-700 rounded-lg font-bold shadow hover:bg-blue-100 transition tilt"
              >
                Our Services
              </a>
              <a
                href="#community"
                className="px-6 py-3 border border-white text-white rounded-lg font-bold hover:bg-white hover:text-blue-700 transition tilt"
              >
                Join Community
              </a>
            </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-10 md:p-16 flex flex-col md:flex-row items-center gap-10 fade-in-up">
          <div className="md:w-2/3">
            ...
            <p className="text-gray-600 text-lg mb-4">
              At DoTech, we are passionate technologists, researchers, and
              creators. Our mission is to empower innovation, foster learning,
              and connect a vibrant community of forward-thinkers.
            </p>
      ...
      >
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-extrabold text-center text-blue-800 mb-12 fade-in-up">
            Our IT Services
          </h2>
          <div className="grid md:grid-cols-3 gap-10">
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center card-hover transition-transform duration-300 fade-in-up">
              ...
              <p className="mb-4 text-gray-600">
                Intuitive, beautiful interfaces for web & mobile, focused on
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center card-hover transition-transform duration-300 fade-in-up delay-100">
              ...
              <p className="mb-4 text-gray-600">
                Robust, scalable, and secure solutions tailored to your needs
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center card-hover transition-transform duration-300 fade-in-up delay-200">
              ...
              <p className="mb-4 text-gray-600">
                From MVPs to enterprise, we deliver high-quality software,
                infrastructure, and expert advice.
              </p>
            </div>
          </div>
          <div className="text-center mt-10 fade-in-up delay-300">
            <a
              href="#contact"
              className="inline-block px-10 py-4 bg-blue-700 text-white rounded-xl shadow hover:bg-blue-800 transition text-lg font-bold shine"
            >
              Request a Quote
            </a>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="bg-blue-50 rounded-2xl shadow p-8 text-center hover:shadow-xl transition fade-in-up">
              ...
              <p className="text-gray-600">
                Connect with innovators, attend workshops, and join our regular
                tech meetups.
              </p>
            </div>
            <div className="bg-blue-50 rounded-2xl shadow p-8 text-center hover:shadow-xl transition fade-in-up delay-100">
              ...
              <p className="text-gray-600">
                Read our blog, join the forum, and contribute to open
            ...
            <div className="bg-blue-50 rounded-2xl shadow p-8 text-center hover:shadow-xl transition fade-in-up delay-200">
              ...
              <p className="text-gray-600">
                Work together on open source and community-driven projects that
          ...
          <div className="flex flex-wrap justify-center gap-10">
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center w-72 card-hover transition-transform duration-300 fade-in-up">
              <Image
                ...
                alt="John Doe"
                className="w-24 h-24 rounded-full mx-auto mb-4 border-4 border-blue-200 shadow-lg shine"
                width={96}
                height={96}
              />
              ...
              <p className="text-gray-500">
                Expert in cloud infrastructure and automation, ensuring
                reliability and scalability for all our projects.
              </p>
            </div>
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center w-72 card-hover transition-transform duration-300 fade-in-up delay-100">
              ...
              <p className="text-gray-500">
                Passionate about UI/UX, Tinh brings ideas to life with creative
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center w-72 card-hover transition-transform duration-300 fade-in-up delay-200">
              ...
              <p className="text-gray-500">
                Full-stack developer with a knack for building scalable and
      ...
      <section id="contact" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-extrabold text-center text-blue-800 mb-8 fade-in-up">
            Contact Us
          </h2>
          <div className="max-w-xl mx-auto bg-blue-50 rounded-2xl shadow-xl p-10 fade-in-up delay-100">
            ...
            >
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-blue-700 text-white rounded-lg shadow hover:bg-blue-800 transition font-bold shine"
              >
                Send Message
              </button>
            </form>
      ...
      <footer className="relative bg-gradient-to-tr from-blue-900 via-blue-800 to-blue-900 text-white py-14 mt-10 overflow-hidden">
        <div className="container mx-auto px-4 grid md:grid-cols-5 gap-10 relative z-10">
          <div className="md:col-span-2 flex flex-col justify-between">
            ...
            <p className="text-gray-300 text-sm mb-6">
              Empowering innovation, research, and learning in technology. Join
              us to shape tomorrow.
            </p>
            <div className="flex gap-4">
              ...
              >
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M1.5 4.5h21a1.5 1.5 0 0 1 1.5 1.5v12a1.5 1.5 0 0 1-1.5 1.5h-21A1.5 1.5 0 0 1 0 18V6a1.5 1.5 0 0 1 1.5-1.5zm10.5 8.25L3.75 6.75h16.5L12 12.75zm-9 6.75h18V8.25l-9 6.75-9-6.75V18z" />
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                <a href="#team" className="hover:text-blue-300 transition">
                  Team
                </a>
              </li>
              <li>
        ...
        <div className="text-center text-blue-200 mt-10 text-xs relative z-10">
          <span className="inline-flex items-center gap-2">
            <svg
              className="w-4 h-4 text-blue-300 inline-block animate-pulse"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
  ...
  return (
    ...
    >
      <input
        ...
        className="px-3 py-2 rounded bg-blue-800/30 border border-blue-700 text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-400"
      />
      <button
        type="submit"
        className="bg-blue-600 hover:bg-blue-700 transition text-white rounded px-3 py-2 font-semibold"
      >
        Subscribe
      </button>
      <span
        id="newsletter-success"
        className={`text-green-300 text-xs mt-1 ${show ? "" : "hidden"}`}
      >
        Subscribed! 🎉
      </span>
    </form>

  ...
  <div className="relative bg-white rounded-3xl overflow-hidden shadow-xl">
    <div className="p-8">
      <Lottie
        ...
        style={{ maxWidth: "600px", margin: "0 auto" }}
      />
      <h4 className="text-2xl font-semibold mb-4">Notre Expertise</h4>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
      {[
        ...
        <motion.div
          ...
          className="group relative"
        >
          <div className={`absolute inset-0 bg-gradient-to-br ${member.color} rounded-2xl blur-xl transition-all duration-300 group-hover:scale-105`} />
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="flex justify-center md:justify-start space-x-4">
                  {[
                    { href: member.social.github, icon: (
      ...
      {/* Footer */}
<footer className="relative bg-gray-900 text-white pt-20 pb-12 overflow-hidden" id="footer">
  {/* Background Effects */}
  <div className="absolute inset-0 bg-grid-white/[0.02] bg-[size:60px_60px]" />
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
      ...
      <div className="space-y-6">
        ...
        <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
          Building innovative solutions to empower businesses in the digital age.
        </p>
        <motion.div className="flex space-x-4">
          {[
            { href: socialTeam.docovery.linkedin, icon: (
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
            )},
            { href: socialTeam.docovery.facebook, icon: (
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            )},
            { href: socialTeam.docovery.instagram, icon: (
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div>
        ...
        <ul className="space-y-4">
          ...
          <li className="flex items-center space-x-3 text-gray-400 hover:text-white transition-colors">
            ...
            <a href="mailto:davidbanitongwa@gmail.com">davidbanitongwa@gmail.com</a>
          </li>
          <li className="flex items-center space-x-3 text-gray-400 hover:text-white transition-colors">
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div>
        ...
        <ul className="space-y-4">
          {['Accueil', 'À propos', 'Services', 'Équipe'].map((item, index) => (
            <li key={index}>
